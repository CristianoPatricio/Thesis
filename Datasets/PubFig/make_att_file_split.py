...
if __name__ == '__main__':
    ...
    shuffle_identities = np.random.permutation(range(0, n_identities))
    ...
    for i in training_classes:
        ...
        if len(samples) < 2:
            ...
            samples_train = identity_info[i][:-5]
            samples_test_seen = identity_info[i][-5:]
    ...
    with open("pubfig_att_split_norm.pickle", "wb") as f:
        pickle.dump(dict, f)