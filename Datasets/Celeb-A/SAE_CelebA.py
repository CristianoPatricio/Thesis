...
class SAE():
    ...
    def __init__(self):
        ...
        with open("/home/cristianopatricio/PycharmProjects/Celeb-A/vgg16.pickle", "rb") as f:
            dataset = pickle.load(f)

        with open("/home/cristianopatricio/PycharmProjects/Celeb-A/att_split.pickle", "rb") as f:
