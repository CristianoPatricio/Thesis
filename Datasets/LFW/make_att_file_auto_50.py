...
# Collect attributes
att_info = load_lfw_attrs('/home/cristianopatricio/Documents/Datasets/LFW/LFW_SoftBiometrics/files/LFW_AutomaticAnnotations.txt')
...
with open("lfw_att_auto_split_50_norm.pickle", "wb") as f:
    pickle.dump(dict, f)
