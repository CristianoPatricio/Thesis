...
for i in range(1000000):
    ...
    if i % 1000 == 0:
        ...
        acc_seen_gzsl = compute_accuracy(attribute, x_test_seen, np.arange(50), test_label_seen)
        acc_unseen_gzsl = compute_accuracy(attribute, x_test, np.arange(50), test_label)
